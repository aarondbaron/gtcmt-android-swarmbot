...
class HCView extends SampleCvViewBase implements OnTouchListener{
    private static final String TAG = "Sample::HCView";
    private Mat                 mRgba;
    private Mat                 mGray;
    private Mat mHSV;
    private Mat test;
    ...
    public HCView(Context context, AttributeSet attrs, int defStyle)
    {
