...
public abstract class SampleCvViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public SampleCvViewBase(Context context, AttributeSet attrs) {
        ...
        mHolder.addCallback(this);
        mFps = new FpsMeter();
        Log.i(TAG, "Instantiated new " + this.getClass() + "2nd");
    }
    ...
    public SampleCvViewBase(Context context, AttributeSet attrs, int defStyle) {
        ...
        mHolder.addCallback(this);
        mFps = new FpsMeter();
        Log.i(TAG, "Instantiated new " + this.getClass() + "3rd");
        ...
        while (true) {
            ...
            if (bmp != null) {
                ...
                if (canvas != null) {
                	...
                	//canvas.drawBitmap(bmp, (canvas.getHeight() - bmp.getHeight() ) / 2, (canvas.getWidth() - bmp.getWidth()) / 2, null);
